...
|---:|---|---:|---:|---|---|
| 1 | UnsafeLabs/Bounty-Hunters | 914 | 85 | HIGH | [ Crypto ] Fix phantom reward accrual after period expiry in YieldVault |
| 2 | zhangjiayang6835-cyber/bounty-plaza | 52 | 70 | HIGH | [Bounty] [Bounty] [BUG] Clickjacking via X-Frame-Options Missing → Crypto Withdraw $120 |
| 3 | zhangjiayang6835-cyber/bounty-plaza | 152 | 70 | HIGH | [Bounty] [Bounty] [Bounty] [BUG] Clickjacking via X-Frame-Options Missing → Crypto Withdr |
| 4 | Scottcjn/rustchain-bounties | 13690 | 65 | HIGH | [Bounty Claim] RustChain PR #13654 - Reinstatement of removed rtc-reward.yml workflow (Bounty #1009, 40 RTC, CHANGES_REQUESTED) |
| 5 | Ikalus1988/MisakaNet | 429 | 65 | HIGH | [Bounty][$0][agent competition] Blind test homepage SAG-Lite lesson search |
| 6 | thxprotocol/monorepo-legacy | 882 | 60 | HIGH | Reward Payment Methods |
| 7 | dolr-ai/yral | 819 | 60 | HIGH | Reward + Winnings Wallet |
